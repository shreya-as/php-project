...
if($picture_type=="image/jpeg" || $picture_type=="image/jpg" || $picture_type=="image/png" || $picture_type=="image/gif")
{
	if($picture_size<=500000)
	{
		...
		echo $sql="insert into products (cat_id,brand_id,product_name, details, image, price, c_price, product_keywords) values ('$product_cat','$product_brand','$product_name','$details','$picture_name','$price','$c_price','$product_keywords')" ;
...
<span><select name="product_cat">
            <option style="padding-left: 10px">Select a Category</option>
            <?php
...
<span><select name="product_brand" style ="margin-top:15px">
        ...
        <input class="input-lg thumbnail form-control" type="text" name="product_keywords"   placeholder="Enter Keywords" required>
      </div>
</div>  
