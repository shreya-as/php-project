...
<tr><th>Image</th><th>Name</th> <th>Price</th><th>
	<a  href="add_product.php">Edit</a></th></tr>
	<a href='tablets_list.php?product_id=$product_id&action=delete'>Delete</a>
	<!-- class=" btn btn-primary" -->
<?php 
$result=mysqli_query($connection,"select * from products where product_name='tablets'");
while($row=mysqli_fetch_array($result)){?>
		<tr>

			<td> <img src="images/products/<?php echo $row['image'];?>" height="50" width="50"></td>
			<td><?php echo $row['product_name'];?></td>
			<td><?php echo $row['price'];?></td>
			<td><a href='tablets_list.php?product_id=$product_id&action=delete'>Delete</a></td>
		</tr>
<?php		
}
